...
python -u ac_env_solver/search/miller_schupp/miller_schupp.py --min-n=3 --max-n=5 --min-w-len=2 --max-w-len=3 --search-fn=greedy
...
from ac_env_solver.envs.ac_env import simplify_relator
